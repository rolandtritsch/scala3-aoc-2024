...
/** Day19 - Linen Layout
  *
  * Seems that (at least for part1) we can cheat a bit and use regular expressions to do the job for
  * us.
  *
  * The first line of the inpu gives us a list of tokens. We can then pattern match on the given
  * token strings to find the ones that are possible.
  *
  * Part1:
  *
  *   - Read the input file
